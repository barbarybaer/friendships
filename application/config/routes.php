...
$route['default_controller'] = 'Sessions/main';
$route['main'] = 'Sessions/main';
$route['login'] = 'Sessions/login';
$route['register'] = 'Sessions/register';
$route['logoff'] = 'Sessions/logoff';
$route['friends'] = 'Friends/index';
$route['add/(:num)'] = 'Friends/addFriend/$1';
$route['remove/(:num)'] = 'Friends/removeFriend/$1';
$route['user/(:num)'] = 'Friends/getProfile/$1';
